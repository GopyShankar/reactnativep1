...
export function SignInForm({ props }) {
  ...
  return (
    <KeyboardAwareScrollView contentContainerStyle={{ flexGrow: 1, }} style={{ flex: 1, }} >
      <VStack flex="1" px="6" py="9" _light={{ bg: "white", }} _dark={{ bg: "coolGray.800", }} space="3"
      ...
      >
          ...
          <VStack>
            <VStack space="3">
              <VStack space={{ base: "7", md: "4", }} >
                <FloatingLabelInput isRequired label="Email" labelColor="#9ca3af"
                ...
                <FloatingLabelInput
                  ...
                  InputRightElement={
                    <IconButton variant="unstyled"
                      icon={
                        <Icon size="4" color="coolGray.400" as={Entypo} name={showPass ? "eye-with-line" : "eye"} />
                      }
                      onPress={() => {
                        setShowPass(true);
                      }}
              ...
              <Link ml="auto"
                _text={{ fontSize: "xs", fontWeight: "bold", textDecoration: "none", }}
        ...
        <HStack mb="4" space="1" safeAreaBottom alignItems="center" justifyContent="center" mt={{ base: "auto", md: "8", }} >
        ...
        <Stack flexDirection={{ base: "column", md: "row", }} w="100%" maxW={{ md: "1016px", }} flex={{ base: "1", md: "none", }} >
          <VStack px="4" mt="4" mb="5" space="9">
            <HStack space="2" alignItems="center">
              <Text color="coolGray.50" fontSize="lg"> </Text>
            </HStack>
            <VStack space="2">
